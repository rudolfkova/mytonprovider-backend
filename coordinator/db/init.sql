...
(
    ...
    reason_code     integer,
    error_message   text,
    run_id          character varying(128) COLLATE pg_catalog."default" NOT NULL,
    worker          character varying(64) COLLATE pg_catalog."default" NOT NULL DEFAULT 'StoreProof',
    created_at      timestamp with time zone NOT NULL DEFAULT now()
);

CREATE INDEX IF NOT EXISTS idx_provider_pipeline_events_pubkey_created
    ON providers.provider_pipeline_events (provider_pubkey COLLATE pg_catalog."default", created_at DESC);
...
(
    id                bigserial PRIMARY KEY,
    provider_pubkey   character varying(64) COLLATE pg_catalog."default" NOT NULL,
    contract_address  character varying(64) COLLATE pg_catalog."default" NOT NULL,
    bag_id            character varying(64) COLLATE pg_catalog."default" NOT NULL,
    status            character varying(8) NOT NULL CHECK (status IN ('error', 'ok')),
    stage             character varying(64) COLLATE pg_catalog."default" NOT NULL,
    reason_code       integer,
...
CREATE INDEX IF NOT EXISTS idx_bag_pipeline_events_provider_created
    ON providers.bag_pipeline_events (provider_pubkey COLLATE pg_catalog."default", created_at DESC);

CREATE INDEX IF NOT EXISTS idx_bag_pipeline_events_bag_created
    ON providers.bag_pipeline_events (bag_id COLLATE pg_catalog."default", created_at DESC);

CREATE INDEX IF NOT EXISTS idx_bag_pipeline_events_contract_provider_created
    ON providers.bag_pipeline_events (contract_address COLLATE pg_catalog."default", provider_pubkey COLLATE pg_catalog."default", created_at DESC);
